...
The language server SHALL publish diagnostics for all tree-sitter `ERROR` nodes found in an IDL document's current parse tree.
...
The server MUST regenerate diagnostics from the latest full parse tree whenever the document is opened or changed.
